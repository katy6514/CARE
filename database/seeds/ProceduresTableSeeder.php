...
class ProceduresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $animal_id = \CARE\Animal::where('sub_species','=','tiger')->pluck('id')->first();
        ...
        $animal_id = \CARE\Animal::where('sub_species','=','lion')->pluck('id')->first();
        DB::table('procedures')->insert([
            'created_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'updated_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'date' => $faker->date($format = 'Y-m-d', $max = 'now'),
        ...
        $animal_id = \CARE\Animal::where('sub_species','=','bobcat')->pluck('id')->first();
        DB::table('procedures')->insert([
            'created_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'updated_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'date' => $faker->date($format = 'Y-m-d', $max = 'now'),
        ...
        $animal_id = \CARE\Animal::where('sub_species','=','cougar')->pluck('id')->first();
        DB::table('procedures')->insert([
            'created_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'updated_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'date' => $faker->date($format = 'Y-m-d', $max = 'now'),
        ...
        $animal_id = \CARE\Animal::where('sub_species','=','leopard')->pluck('id')->first();
        DB::table('procedures')->insert([
            'created_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'updated_at' => \Carbon\Carbon::now()->toDateTimeString(),
            'date' => $faker->date($format = 'Y-m-d', $max = 'now'),
